...
import com.mycompany.petbuddyy.dao.CategoryDao;
import com.mycompany.petbuddyy.dao.ProductDao;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (op.trim().equals("addcategory")) {
                ...
                Part part1 = request.getPart("catPic");

                category category = new category();
                category.setCategoryTitle(title);
                category.setCategoryDescription(description);
                category.setCategoryPhoto(part1.getSubmittedFileName());
//category pic
                String path = request.getRealPath("img") + File.separator + "products" + File.separator + part1.getSubmittedFileName();
